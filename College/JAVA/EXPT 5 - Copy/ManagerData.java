...
class Manager extends Employee {
    ...
    public void display() {
        Scanner sc = new Scanner(System.in);
        System.out.println("employee no of manager = " + eno);
        System.out.println("name of manager = " + name);
        System.out.println("address of manager = " + address);
        System.out.println("phone no of manager = " + phone_no);
        System.out.println("department no of manager = " + department_name);
        System.out.println("phone no of manager = " + basic_salary);
